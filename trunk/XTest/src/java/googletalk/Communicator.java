...
public class Communicator {
	...
	public static final int PACKET_REPLY_TIMEOUT = 500,
			DEFAULT_XMPP_SERVER_PORT = 5222;
	...
	public Communicator(String serverAddress, Integer serverPort,
		...
		ConnectionConfiguration config = new ConnectionConfiguration(
				serverAddress, serverPort != null ? serverPort
						: DEFAULT_XMPP_SERVER_PORT, XMPP_HOST_NAME, ProxyInfo
						.forDefaultProxy());
...
//		SASLAuthentication.supportSASLMechanism("PLAIN");
	...
	public void setStatus(boolean available, String status) {
		Presence presence = new Presence(available ? Type.available
				: Type.unavailable);
	...
	public boolean sendMessage(String msgText, String to) throws XMPPException {
		...
		// important bit is to set Message type to 'chat', Google seems to
		// ignore the default type
	...
	public static void main(String args[]) {
		try {
			...
			comm.sendMessage("Hello. гоюл", "ppjjuu");
			JOptionPane.showMessageDialog(null,
					"Close this when you want to quit");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
